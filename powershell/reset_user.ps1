...
function CreateUser {
  ...
  New-LocalUser $Username -Password $Password -FullName $Username -Description "New User" -AccountNeverExpires:$true -PasswordNeverExpires:$true -UserMayNotChangePassword:$true 
}
